...
var ApiService = (function () {
    ...
    ApiService.prototype.retrieveUser = function (username) {
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.calculateScore = function (username) {
        var _this = this;
        console.log('step 1');
        ...
        if (this.promise) {
            ...
            this.promise
                ...
                if (user.id) {
                    _this.score = user.public_repos + user.followers;
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_5" /* ViewChild */])('form'),
